...
export const GameOverModal = ({ isOpen, winnerName, isWinner, onClose }: GameOverModalProps) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className="relative w-full max-w-md rounded-2xl border-2 border-accent-500/30 p-8 text-center"
            style={{
          ...
          >
            ...
            {/* Title */}
            <h2 className="text-4xl font-bold text-accent-300 mb-4 font-cyber">
              {isWinner ? 'YOU WIN!' : 'GAME OVER'}
            </h2>

            {/* Winner */}
            <p className="text-text-main text-xl mb-2">
              🎉 {winnerName} 🎉
            </p>
