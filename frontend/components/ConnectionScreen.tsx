...
export function ConnectionScreen({ error }: { error: string | null }) {
  return (
    <div className="flex h-screen-mobile items-center justify-center bg-background p-4 safe-bottom">
      <motion.div
      ...
      >
        ...
        {error ? (
          <p className="text-danger-400 font-cyber text-sm sm:text-base mb-2 leading-relaxed">{error}</p>
        ) : (
